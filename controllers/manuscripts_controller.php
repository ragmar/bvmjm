	...
	function add() {
		...
		if (!empty($this->data)) {
			...
			if ($_FILES['data']['error']['Manuscript']['cover'] == 0){
				...
				$uploadfile = $uploaddir . basename($time.'_'.$this->data['Manuscript']['cover']['name']);
				copy($_FILES['data']['tmp_name']['Manuscript']['cover'], $uploadfile);
			}

			if ($_FILES['data']['error']['Manuscript']['item'] == 0){
				$uploaddir = "..".DS."webroot".DS."files".DS;
				$uploadfile = $uploaddir . basename($time.'_'.$this->data['Manuscript']['item']['name']);
				copy($_FILES['data']['tmp_name']['Manuscript']['item'], $uploadfile);
			}
			
			if ($_FILES['data']['error']['Manuscript']['item'] == 0){
				
				$data['Manuscript']['item_file_path'] = $time.'_'.$data['Manuscript']['item']['name'];
				$data['Manuscript']['item_content_type'] = $data['Manuscript']['item']['type'];
				$data['Manuscript']['item_file_size'] = $data['Manuscript']['item']['size'];
				$data['Manuscript']['item_file_name'] = $data['Manuscript']['item']['name'];
				
				$data['Manuscript']['cover_path'] = $time.'_'.$data['Manuscript']['cover']['name'];
				$data['Manuscript']['cover_type'] = $this->data['Manuscript']['cover']['type'];
				$data['Manuscript']['cover_size'] = $this->data['Manuscript']['cover']['size'];
				$data['Manuscript']['cover_name'] = $this->data['Manuscript']['cover']['name'];
...
//---------------------------Sub-Campo 700a----------------------------//
	...
	function edit($id = null) {
		...
		if (!empty($this->data)) {
			...
			if ($_FILES['data']['error']['Manuscript']['item'] == 0){
				$uploaddir =".." .DS."html".DS."app".DS."webroot".DS."files".DS;
				$uploadfile = $uploaddir . basename($time.'_'.$this->data['Manuscript']['item']['name']);
				copy($_FILES['data']['tmp_name']['Manuscript']['item'], $uploadfile);
