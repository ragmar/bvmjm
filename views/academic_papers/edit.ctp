...
<ul class="breadcrumb" style="margin: 0">
  ...
  <li>Modificar Trabajo Acad&eacute;mico</li>
</ul>

<div class="items">
<div class="col-md-12 column">
<h2>Modificar Trabajo Acad&eacute;mico</h2>
						...
						<?php
							...
							if (($c0080710_1 != "||||") && ($c0080710_1 != '#') && ($c0080710_1 != 'u')) { // Caso 1.
								...
								if ((substr($c008, 13, 1) != '#') && (substr($c008, 13, 1) != '|') && (substr($c008, 13, 1) != 'u')) {
									...
									$c0082427 = substr($c008, 22, 1);
									$c0083537 = substr($c008, 23, 3);
								} else {
									if (substr($c008, 13, 1) == '|') {
										$c0080710_3 = "||||";
										$c0081517 = substr($c008, 17, 3);
										$c0082427 = substr($c008, 20, 1);
										$c0083537 = substr($c008, 21, 3);
									} else {
										$c0080710_3 = substr($c008, 13, 1);
										$c0081517 = substr($c008, 14, 3);
										$c0082427 = substr($c008, 17, 1);
										$c0083537 = substr($c008, 18, 3);
									}
								}
							}
							...
							if (($c0080710_1 == '#') || ($c0080710_1 == 'u')) { // Caso 2 y 3. 
								...
								if ((substr($c008, 8, 1) != '|') && (substr($c008, 8, 1) != '#') && (substr($c008, 8, 1) != 'u')) {
									...
									if (substr($c008, 11, 1) == '|') {
										...
										$c0082427 = substr($c008, 15, 1);
										$c0083537 = substr($c008, 16, 3);
									} else {
										$c0080710_3 = substr($c008, 8, 1);
										$c0081517 = substr($c008, 9, 3);
										$c0082427 = substr($c008, 12, 1);
										$c0083537 = substr($c008, 13, 3);
									}
								}
							}
						?>
...
<?php $c502 = marc21_decode($item['Item']['502']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>502</b></th>
		<th style="width: 45%;"><b>Nota de Tesis.</b></th>
		<th style="width: 45%;">
			<label id="l-502"><?php echo $item['Item']['502']; ?></label>
			<?php echo $this->Form->hidden('502', array('id' => '502', 'label' => false, 'div' => false, 'value' => $item['Item']['502'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c502['a'])) {
				echo $this->Form->input('502a', array('id' => '502a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c502['a']));
			} else {
				echo $this->Form->input('502a', array('id' => '502a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c504 = marc21_decode($item['Item']['504']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>504</b></th>
		<th style="width: 45%;"><b>Nota de bibliografía, etc.</b></th>
		<th style="width: 45%;">
			<label id="l-504"><?php echo $item['Item']['504']; ?></label>
			<?php echo $this->Form->hidden('504', array('id' => '504', 'label' => false, 'div' => false, 'value' => $item['Item']['504'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c504['a'])) {
				echo $this->Form->input('504a', array('id' => '504a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c504['a']));
			} else {
				echo $this->Form->input('504a', array('id' => '504a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
