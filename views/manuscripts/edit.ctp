...
<table class="table">
	...
	<tr>
		...
		'options' => array(
			...
			<script type="text/javascript">
			// Se ordena la lista.
			$("#008-18-19").append($("#008-18-19 option").remove().sort(function(a, b) {
			    var at = $(a).text(), bt = $(b).text();
			    return (at > bt)?1:((at < bt)?-1:0);
			}));
			$('#008-18-19').val('<?php echo $c0081819; ?>');
		</script>
			</td>
	</tr>	
	<tr>
	...
	<tr>
		...
		<script type="text/javascript">
			// Se ordena la lista.
			$("#008-24-29").append($("#008-24-29 option").remove().sort(function(a, b) {
			    var at = $(a).text(), bt = $(b).text();
			    return (at > bt)?1:((at < bt)?-1:0);
			}));
			$('#008-24-29').val('<?php echo $c0082429; ?>');
		</script>
		</td>
	</tr>
	<tr>
...
<?php $c031 = marc21_decode($item['Item']['031']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>031</b></th>
		<th style="width: 45%;"><b>Información del íncipit musical.</b></th>
		<th style="width: 45%;">
			<label id="l-031"><?php echo $item['Item']['031']; ?></label>
			<?php echo $this->Form->hidden('031', array('id' => '031', 'label' => false, 'div' => false, 'value' => $item['Item']['031'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c031['a'])) {
				echo $this->Form->input('031a', array('id' => '031a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['a']));
			} else {
				echo $this->Form->input('031a', array('id' => '031a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['b'])) {
				echo $this->Form->input('031b', array('id' => '031b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['b']));
			} else {
				echo $this->Form->input('031b', array('id' => '031b', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['c'])) {
				echo $this->Form->input('031c', array('id' => '031c', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['c']));
			} else {
				echo $this->Form->input('031c', array('id' => '031c', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['d'])) {
				echo $this->Form->input('031d', array('id' => '031d', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['d']));
			} else {
				echo $this->Form->input('031d', array('id' => '031d', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['e'])) {
				echo $this->Form->input('031e', array('id' => '031e', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['e']));
			} else {
				echo $this->Form->input('031e', array('id' => '031e', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['g'])) {
				echo $this->Form->input('031g', array('id' => '031g', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['g']));
			} else {
				echo $this->Form->input('031g', array('id' => '031g', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['m'])) {
				echo $this->Form->input('031m', array('id' => '031m', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['m']));
			} else {
				echo $this->Form->input('031m', array('id' => '031m', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['n'])) {
				echo $this->Form->input('031n', array('id' => '031n', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['n']));
			} else {
				echo $this->Form->input('031n', array('id' => '031n', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['o'])) {
				echo $this->Form->input('031o', array('id' => '031o', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['o']));
			} else {
				echo $this->Form->input('031o', array('id' => '031o', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			if (isset($c031['p'])) {
				...
				echo $this->Form->input('031p', array('id' => '031p', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['q'])) {
				echo $this->Form->input('031q', array('id' => '031q', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['q']));
			} else {
				echo $this->Form->input('031q', array('id' => '031q', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['r'])) {
				echo $this->Form->input('031r', array('id' => '031r', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['r']));
			} else {
				echo $this->Form->input('031r', array('id' => '031r', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['s'])) {
				echo $this->Form->input('031s', array('id' => '031s', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['s']));
			} else {
				echo $this->Form->input('031s', array('id' => '031s', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['t'])) {
				echo $this->Form->input('031t', array('id' => '031t', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['t']));
			} else {
				echo $this->Form->input('031t', array('id' => '031t', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['u'])) {
				echo $this->Form->input('031u', array('id' => '031u', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['u']));
			} else {
				echo $this->Form->input('031u', array('id' => '031u', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['y'])) {
				echo $this->Form->input('031y', array('id' => '031y', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['y']));
			} else {
				echo $this->Form->input('031y', array('id' => '031y', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['z'])) {
				echo $this->Form->input('031z', array('id' => '031z', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['z']));
			} else {
				echo $this->Form->input('031z', array('id' => '031z', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['2'])) {
				echo $this->Form->input('0312', array('id' => '0312', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['2']));
			} else {
				echo $this->Form->input('0312', array('id' => '0312', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['6'])) {
				echo $this->Form->input('0316', array('id' => '0316', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['6']));
			} else {
				echo $this->Form->input('0316', array('id' => '0316', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c031['8'])) {
				echo $this->Form->input('0318', array('id' => '0318', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['8']));
			} else {
				echo $this->Form->input('0318', array('id' => '0318', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		'options' => array(
				...
				'-yu' => '-yu - Serbia and Montenegro',
				'-za' => '-za - Zambia'
				), 'selected' => substr($c044['indicators'], 1, 1)
		));
...
<?php $c047 = marc21_decode($item['Item']['047']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>047</b></th>
		<th style="width: 45%;"><b>Código de forma de composición musical.</b></th>
		<th style="width: 45%;">
			<label id="l-047"><?php echo $item['Item']['047']; ?></label>
			<?php echo $this->Form->hidden('047', array('id' => '047', 'label' => false, 'div' => false, 'value' => $item['Item']['047'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>I1</b></td>
		...
		<td><?php echo $this->Form->input('047i1', array('id' => '047i1', 'label' => false, 'div' => false, 'class' => 'form-control',
			'options' => array(
				'#' => '# - No se proporciona información'
			), 'selected' => substr($c047['indicators'], 0, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>I2</b></td>
		...
		<td><?php echo $this->Form->input('047i2', array('id' => '047i2', 'label' => false, 'div' => false, 'class' => 'form-control',
			'options' => array(
					'#' => '# - Código MARC de lengua',
					'7' => '7 - Fuente especificada en el subcampo $b'
			), 'selected' => substr($c047['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
		<td>Código de la forma de composición musical.</td>
...
<?php $c048 = marc21_decode($item['Item']['048']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>048</b></th>
		<th style="width: 45%;"><b>Número de instrumentos y voces.</b></th>
		<th style="width: 45%;">
			<label id="l-048"><?php echo $item['Item']['048']; ?></label>
			<?php echo $this->Form->hidden('048', array('id' => '048', 'label' => false, 'div' => false, 'value' => $item['Item']['048'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>I1</b></td>
		...
		<td><?php echo $this->Form->input('048i1', array('id' => '048i1', 'label' => false, 'div' => false, 'class' => 'form-control', 
			'options' => array(
				'#' => '# - No definido',
			), 'selected' => substr($c048['indicators'], 0, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>I2</b></td>
		...
		<td><?php echo $this->Form->input('048i2', array('id' => '048i2', 'label' => false, 'div' => false, 'class' => 'form-control',
			...
			), 'selected' => substr($c048['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
		<td>Código de ejecutante o conjunto.</td>
...
'zu' => 'zu Desconocido'
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c048['b'])) {
				echo $this->Form->input('048b', array('id' => '048b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c048['b']));
			} else {
				echo $this->Form->input('048b', array('id' => '048b', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c254 = marc21_decode($item['Item']['254']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>254</b></th>
		<th style="width: 45%;"><b>Mención de presentación musical.</b></th>
		<th style="width: 45%;">
			<label id="l-254"><?php echo $item['Item']['254']; ?></label>
			<?php echo $this->Form->hidden('254', array('id' => '254', 'label' => false, 'div' => false, 'value' => $item['Item']['254'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		<td>Mención de presentación musical.</td>
		<td>
			<?php
			if (isset($c254['a'])) {
				echo $this->Form->input('254a', array('id' => '254a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c254['a']));
			} else {
				echo $this->Form->input('254a', array('id' => '254a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c254['b'])) {
				echo $this->Form->input('254b', array('id' => '254b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c254['b']));
			} else {
				echo $this->Form->input('254b', array('id' => '254b', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c306 = marc21_decode($item['Item']['306']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>306</b></th>
		<th style="width: 45%;"><b>Duración.</b></th>
		<th style="width: 45%;">
			<label id="l-306"><?php echo $item['Item']['306']; ?></label>
			<?php echo $this->Form->hidden('306', array('id' => '306', 'label' => false, 'div' => false, 'value' => $item['Item']['306'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c306['a'])) {
				echo $this->Form->input('306a', array('id' => '306a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c306['a']));
			} else {
				echo $this->Form->input('306a', array('id' => '306a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c306['b'])) {
				echo $this->Form->input('306b', array('id' => '306b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c306['b']));
			} else {
				echo $this->Form->input('306b', array('id' => '306b', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	<tr>
		...
		<th style="width: 45%;">
			<label id="l-380"><?php echo $item['Item']['381']; ?></label>
			<?php echo $this->Form->hidden('380', array('id' => '380', 'label' => false, 'div' => false, 'value' => $item['Item']['381'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c380['0'])) {
				echo $this->Form->input('3800', array('id' => '3800', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c380['0']));
			} else {
				echo $this->Form->input('3800', array('id' => '3800', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c380['2'])) {
				echo $this->Form->input('3802', array('id' => '3802', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c380['2']));
			} else {
				echo $this->Form->input('3802', array('id' => '3802', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c380['6'])) {
				echo $this->Form->input('3806', array('id' => '3806', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c380['6']));
			} else {
				echo $this->Form->input('3806', array('id' => '3806', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c380['8'])) {
				echo $this->Form->input('3808', array('id' => '3808', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c380['8']));
			} else {
				echo $this->Form->input('3808', array('id' => '3808', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c381 = marc21_decode($item['Item']['381']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>381</b></th>
		<th style="width: 45%;"><b>Otras características distintivas de obra (Compás).</b></th>
		<th style="width: 45%;">
			<label id="l-381"><?php echo $item['Item']['381']; ?></label>
			<?php echo $this->Form->hidden('381', array('id' => '381', 'label' => false, 'div' => false, 'value' => $item['Item']['381'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c381['a'])) {
				echo $this->Form->input('381a', array('id' => '381a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c381['a']));
			} else {
				echo $this->Form->input('381a', array('id' => '381a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c382 = marc21_decode($item['Item']['382']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>382</b></th>
		<th style="width: 45%;"><b>Medio de interpretación.</b></th>
		<th style="width: 45%;">
			<label id="l-382"><?php echo $item['Item']['382']; ?></label>
			<?php echo $this->Form->hidden('382', array('id' => '382', 'label' => false, 'div' => false, 'value' => $item['Item']['382'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c382['a'])) {
				echo $this->Form->input('382a', array('id' => '382a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c382['a']));
			} else {
				echo $this->Form->input('382a', array('id' => '382a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c383 = marc21_decode($item['Item']['383']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>383</b></th>
		<th style="width: 45%;"><b>Designación numérica de obra musical.</b></th>
		<th style="width: 45%;">
			<label id="l-383"><?php echo $item['Item']['383']; ?></label>
			<?php echo $this->Form->hidden('383', array('id' => '383', 'label' => false, 'div' => false, 'value' => $item['Item']['383'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c383['a'])) {
				echo $this->Form->input('383a', array('id' => '383a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c383['a']));
			} else {
				echo $this->Form->input('383a', array('id' => '383a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c383['b'])) {
				echo $this->Form->input('383b', array('id' => '383b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c383['b']));
			} else {
				echo $this->Form->input('383b', array('id' => '383b', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c383['c'])) {
				echo $this->Form->input('383c', array('id' => '383c', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c383['c']));
			} else {
				echo $this->Form->input('383c', array('id' => '383c', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c383['d'])) {
				echo $this->Form->input('383d', array('id' => '383d', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c383['d']));
			} else {
				echo $this->Form->input('383d', array('id' => '383d', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c383['e'])) {
				echo $this->Form->input('383e', array('id' => '383e', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c383['e']));
			} else {
				echo $this->Form->input('383e', array('id' => '383e', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c384 = marc21_decode($item['Item']['384']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>384</b></th>
		<th style="width: 45%;"><b>Tonalidad.</b></th>
		<th style="width: 45%;">
			<label id="l-384"><?php echo $item['Item']['384']; ?></label>
			<?php echo $this->Form->hidden('384', array('id' => '384', 'label' => false, 'div' => false, 'value' => $item['Item']['384'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>I1</b></td>
		...
		<td><?php echo $this->Form->input('384i1', array('id' => '384i1', 'label' => false, 'div' => false, 'class' => 'form-control',
			...
			), 'selected' => substr($c384['indicators'], 0, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>I2</b></td>
		...
		<td><?php echo $this->Form->input('384i2', array('id' => '384i2', 'label' => false, 'div' => false, 'class' => 'form-control', 
			'options' => array(
			'#' => '# - No definido'		
			), 'selected' => substr($c384['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c384['a'])) {
				echo $this->Form->input('384a', array('id' => '384a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c384['a']));
			} else {
				echo $this->Form->input('384a', array('id' => '384a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c508 = marc21_decode($item['Item']['508']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>508</b></th>
		<th style="width: 45%;"><b>Nota de créditos de creación o producción.</b></th>
		<th style="width: 45%;">
			<label id="l-508"><?php echo $item['Item']['501']; ?></label>
			<?php echo $this->Form->hidden('508', array('id' => '508', 'label' => false, 'div' => false, 'value' => $item['Item']['501'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c508['a'])) {
				echo $this->Form->input('508a', array('id' => '508a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c508['a']));
			} else {
				echo $this->Form->input('508a', array('id' => '508a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c518 = marc21_decode($item['Item']['518']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>518</b></th>
		<th style="width: 45%;"><b>Nota de fecha/hora y lugar de un acontecimiento.</b></th>
		<th style="width: 45%;">
			<label id="l-518"><?php echo $item['Item']['518']; ?></label>
			<?php echo $this->Form->hidden('518', array('id' => '518', 'label' => false, 'div' => false, 'value' => $item['Item']['518'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c518['a'])) {
				echo $this->Form->input('518a', array('id' => '518a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c518['a']));
			} else {
				echo $this->Form->input('518a', array('id' => '518a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c520['a'])) {
				echo $this->Form->input('520a', array('id' => 'a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c520['a']));
			} else {
...
<?php $c521 = marc21_decode($item['Item']['521']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>521</b></th>
		<th style="width: 45%;"><b>Nota de audiencia.</b></th>
		<th style="width: 45%;">
			<label id="l-521"><?php echo $item['Item']['521']; ?></label>
			<?php echo $this->Form->hidden('521', array('id' => '521', 'label' => false, 'div' => false, 'value' => $item['Item']['521'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>I1</b></td>
	...
	<tr>
		...
		<td><?php echo $this->Form->input('521i2', array('id' => '521i2', 'label' => false, 'div' => false, 'class' => 'form-control',
			'options' => array(
					'#' => '# - No definido'
			), 'selected' => substr($c521['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c521['a'])) {
				echo $this->Form->input('521a', array('id' => '521a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c521['a']));
			} else {
				echo $this->Form->input('521a', array('id' => '521a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c545 = marc21_decode($item['Item']['545']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>545</b></th>
		<th style="width: 45%;"><b>Datos biográficos o históricos.</b></th>
		<th style="width: 45%;">
			<label id="l-545"><?php echo $item['Item']['545']; ?></label>
			<?php echo $this->Form->hidden('545', array('id' => '545', 'label' => false, 'div' => false, 'value' => $item['Item']['545'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>I1</b></td>
	...
	<tr>
		...
		<td><?php echo $this->Form->input('545i2', array('id' => '545i2', 'label' => false, 'div' => false, 'class' => 'form-control',
			'options' => array(
				'#' => '# - No definido'
			), 'selected' => substr($c545['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c545['a'])) {
				echo $this->Form->input('545a', array('id' => '545a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c545['a']));
			} else {
				echo $this->Form->input('545a', array('id' => '545a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c588 = marc21_decode($item['Item']['561']); ?>
<table class="table">
	<tr>
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c561['a'])) {
				echo $this->Form->input('561a', array('id' => '561a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c561['a']));
			} else {
				echo $this->Form->input('561a', array('id' => '561a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c592 = marc21_decode($item['Item']['592']); ?>
<table class="table">
	<tr>
		<th style="width: 5%;"><b>592</b></th>
		<th style="width: 45%;"><b>Notas al íncipit musical.</b></th>
		<th style="width: 45%;">
			<label id="l-592"><?php echo $item['Item']['592']; ?></label>
			<?php echo $this->Form->hidden('592', array('id' => '592', 'label' => false, 'div' => false, 'value' => $item['Item']['592'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$b</b></td>
		...
		<td>
			<?php
			if (isset($c592['b'])) {
				echo $this->Form->input('592b', array('id' => '592b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c592['b']));
			} else {
				echo $this->Form->input('592b', array('id' => '592b', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c592['c'])) {
				echo $this->Form->input('592c', array('id' => '592c', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c592['c']));
			} else {
				echo $this->Form->input('592c', array('id' => '592c', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		<td><b>$f</b></td>
		<td>Armadura de clave-Tonalidad.</td>
		<td>
			<?php
			if (isset($c592['f'])) {
				echo $this->Form->input('592f', array('id' => '592f', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c592['f']));
			} else {
				echo $this->Form->input('592f', array('id' => '592f', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c592['g'])) {
				echo $this->Form->input('592g', array('id' => '592g', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c592['g']));
			} else {
				echo $this->Form->input('592g', array('id' => '592g', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c593 = marc21_decode($item['Item']['593']); ?>
<table class="table">
	<tr>
		<th style="width: 5%;"><b>593</b></th>
		<th style="width: 45%;"><b>Íncipit musical codificado.</b></th>
		<th style="width: 45%;">
			<label id="l-593"><?php echo $item['Item']['593']; ?></label>
			<?php echo $this->Form->hidden('593', array('id' => '593', 'label' => false, 'div' => false, 'value' => $item['Item']['593'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		<td>Íncipit musical codificado.</font>.</td>
		<td>
			<?php
			if (isset($c593['a'])) {
				echo $this->Form->input('593a', array('id' => '593a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c593['a']));
			} else {
				echo $this->Form->input('593a', array('id' => '593a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		<td><b>$a</b></td>
		<td>Siglo.</td>
		<td><?php echo $this->Form->input('648a', array('id' => '648a', 'label' => false, 'div' => false, 'class' => 'form-control', 'selected' => $c648['a'], 'options' => array('XVII' => 'XVII', 'XVIII' => 'XVIII', 'XIX' => 'XIX', 'XX' => 'XX'))); ?></td>
	</tr>
</table>
...
<div id="8xx" class="tabs" style="display: none;">
	...
	<?php $c800 = marc21_decode($item['Item']['800']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>800</b></th>
		<th style="width: 45%;"><b>Punto de acceso adicional de serie - Nombre de persona.</b></th>
		<th style="width: 45%;">
			<label id="l-800"><?php echo $item['Item']['850']; ?></label>
			<?php echo $this->Form->hidden('800', array('id' => '800', 'label' => false, 'div' => false, 'value' => $item['Item']['800'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>I1</b></td>
		...
		<td><?php echo $this->Form->input('800i1', array('id' => '800i1', 'label' => false, 'div' => false, 'class' => 'form-control', 
			'options' => array(
				...
				'1' => '1 - Apellido(s)',
				'3' => '3 - Nombre de familia'
			), 'selected' => substr($c800['indicators'], 0, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>I2</b></td>
		...
		<td><?php echo $this->Form->input('800i2', array('id' => '800i2', 'label' => false, 'div' => false, 'class' => 'form-control',
			'options' => array(
				'#' => '# - No definido'
			), 'selected' => substr($c800['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c800['a'])) {
				echo $this->Form->input('800a', array('id' => '800a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c800['a']));
			} else {
				echo $this->Form->input('800a', array('id' => '800a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c800['d'])) {
				echo $this->Form->input('800d', array('id' => '800d', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c800['d']));
			} else {
				echo $this->Form->input('800d', array('id' => '800d', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c800['t'])) {
				echo $this->Form->input('800t', array('id' => '800t', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c800['t']));
			} else {
				echo $this->Form->input('800t', array('id' => '800t', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c810 = marc21_decode($item['Item']['810']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>810</b></th>
		<th style="width: 45%;"><b>Punto de acceso adicional de serie - Nombre de entidad.</b></th>
		<th style="width: 45%;">
			<label id="l-810"><?php echo $item['Item']['850']; ?></label>
			<?php echo $this->Form->hidden('810', array('id' => '810', 'label' => false, 'div' => false, 'value' => $item['Item']['810'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>I1</b></td>
		...
		<td><?php echo $this->Form->input('810i1', array('id' => '810i1', 'label' => false, 'div' => false, 'class' => 'form-control', 
			'options' => array(
				...
				'1' => '1 - Nombre de jurisdicción',
				'2' => '2 - Nombre en orden directo'
			), 'selected' => substr($c810['indicators'], 0, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>I2</b></td>
		...
		<td><?php echo $this->Form->input('810i2', array('id' => '810i2', 'label' => false, 'div' => false, 'class' => 'form-control',
			'options' => array(
				'#' => '# - No definido'
			), 'selected' => substr($c810['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c810['a'])) {
				echo $this->Form->input('810a', array('id' => '810a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c810['a']));
			} else {
				echo $this->Form->input('810a', array('id' => '810a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c810['b'])) {
				echo $this->Form->input('810b', array('id' => '810b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c810['b']));
			} else {
				echo $this->Form->input('810b', array('id' => '810b', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c811 = marc21_decode($item['Item']['811']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>811</b></th>
		<th style="width: 45%;"><b>Punto de acceso adicional de serie - Nombre de congreso.</b></th>
		<th style="width: 45%;">
			<label id="l-811"><?php echo $item['Item']['850']; ?></label>
			<?php echo $this->Form->hidden('811', array('id' => '811', 'label' => false, 'div' => false, 'value' => $item['Item']['811'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>I1</b></td>
		...
		<td><?php echo $this->Form->input('811i1', array('id' => '811i1', 'label' => false, 'div' => false, 'class' => 'form-control', 
			'options' => array(
				...
				'1' => '1 - Nombre de jurisdicción',
				'2' => '2 - Nombre en orden directo'
			), 'selected' => substr($c811['indicators'], 0, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>I2</b></td>
		...
		<td><?php echo $this->Form->input('811i2', array('id' => '811i2', 'label' => false, 'div' => false, 'class' => 'form-control',
			'options' => array(
				'#' => '# - No definido'
			), 'selected' => substr($c811['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c811['a'])) {
				echo $this->Form->input('811a', array('id' => '811a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c811['a']));
			} else {
				echo $this->Form->input('811a', array('id' => '811a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c811['d'])) {
				echo $this->Form->input('811d', array('id' => '811d', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c811['d']));
			} else {
				echo $this->Form->input('811d', array('id' => '811d', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php echo $this->Form->hidden('user_id', array('value' => $this->Session->read('Auth.User.id'))); ?>
	...
	<table class="table">
		<tr>
			<th style="width: 50%;">Portada de la obra (preferiblemente jpg o gif). (Obligatorio)</th>
...
$("#384i1").bind('keyup change', function(event) {
		var tmp_384 = "";
	...
	$("#384i2").bind('keyup change', function(event) {
		var tmp_384 = "";
...
$("#592b").bind('keyup change', function(event) {
		var tmp_592 = "";

		if ($('#592b').val().length > 0) {
			tmp_592 = tmp_592 + '^b' + $('#592b').val();
		}
		if ($('#592c').val().length > 0) {
			tmp_592 = tmp_592 + '^c' + $('#592c').val();
		}
		if ($('#592f').val().length > 0) {
			tmp_592 = tmp_592 + '^f' + $('#592f').val();
		}
		if ($('#592g').val().length > 0) {
			tmp_592 = tmp_592 + '^g' + $('#592g').val();
		}
		if (tmp_592.length > 0) {
			$("#592").val('##' + tmp_592);
			$("#l-592").html('##' + tmp_592);
	...
	$("#592c").bind('keyup change', function(event) {
		var tmp_592 = "";
	...
	$("#592f").bind('keyup change', function(event) {
		var tmp_592 = "";
	...
	$("#592g").bind('keyup change', function(event) {
		var tmp_592 = "";
