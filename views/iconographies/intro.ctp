	...
	<div id="wowslider-container1">
	   <div class="ws_images">
			...
			(guitarras y pandereta)</li>
				...
				<li><?php echo $this->Html->image('manuscripts/data1/images/falcn_y_guzmn_blanco_en_el_baile_de_la_bamba.jpg', array( 'alt'=>'falcn_y_guzmn_blanco_en_el_baile_de_la_bamba', 'title'=>'falcn_y_guzmn_blanco_en_el_baile_de_la_bamba', 'id'=>'wows1_2'));?>falcn_y_guzmn_blanco_en_el_baile_de_la_bamba</li>
